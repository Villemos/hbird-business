...
public class ScriptExecutionRequest implements Serializable {
	 ...
	 */
	public ScriptExecutionRequest(String name, String script, String format, EntityInstance output, Map<String, String> inputBinding) {
		this.name = name;
		this.script = script;
		this.format = format;
		this.output = output;
	...
	public ScriptExecutionRequest(String name, String script, String format, EntityInstance output, String input, String binding) {
		this.name = name;
		this.script = script;
		this.format = format;
		this.output = output;
