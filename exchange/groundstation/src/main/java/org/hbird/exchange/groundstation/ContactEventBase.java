 ...
 *
 */
public abstract class ContactEventBase extends Event {

    private static final long serialVersionUID = 783576158497783273L;
     ...
     * @param name
     */
    public ContactEventBase(String ID, String name) {
        super(ID, name);
    }
