...
public class OrbitSimulator {
    ...
    public OrbitSimulator() {
        ...
        initialState = new OrbitalState("Simulator", "Measured Orbital State", "Initial state", (new Date()).getTime(), (new Date()).getTime(), satellite,
                position, velocity, momentum, null);
    }
    ...
    protected void initialize() {
        OrbitPredictionRequest request = new OrbitPredictionRequest(issuedBy, "", "Measured Orbital State", "A simulated orbit.", satellite, initialState,
                locations);
