...
public class OrbitSimulator {
	...
	public OrbitSimulator() {	
		...
		initialState = new OrbitalState("Simulator", "Measured Orbital State", "Measured", "Initial state", (new Date()).getTime(), (new Date()).getTime(), "Test Data", satellite, position, velocity, momentum, "", 0, "");
	}
