...
public class SolrEndpoint extends ScheduledPollEndpoint {
    ...
    protected String uniqueidFieldName = StandardArguments.HAS_URI;
    ...
    protected String[] facetField = { StandardArguments.NAME };
    ...
    protected String facetsort = StandardArguments.COUNT;
            ...
            try {
                if (isEmbedded()) {
                    if (System.getProperty("solr.solr.home") == null) {
                        LOG.info("Solr home not set. Using default value '" + solrhome
                                + "'. Use the route option 'solrhome' to set the home; 'uri=\"solr:foo?solrhome=/my/solr/home\"'");
