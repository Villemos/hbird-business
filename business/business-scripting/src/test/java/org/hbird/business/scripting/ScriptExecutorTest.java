...
public class ScriptExecutorTest {
    ...
    // ScriptExecutionRequest request = new ScriptExecutionRequest("", script, "javascript", new
    // Parameter("ScriptEngine", "Parameter10",
    ...
    // Map<String, String> binding = new HashMap<String, String>();
    // binding.put("Parameter1", "in1");
    // ScriptExecutionRequest request = new ScriptExecutionRequest("", script, "javascript", new State("ScriptEngine",
    // "TestState", "", "Parameter100", true),
    // binding);
    //
    // ScriptExecutor executor = new ScriptExecutor(request);
    //
    ...
    // assertEquals("Parameter100", out.getApplicableTO);
    ...
    // ScriptExecutionRequest request = new ScriptExecutionRequest("Fahrenheit2CelsiusConvertion", "", "javascript", new
    // Parameter("ScriptEngine",
    // "Parameter200", "Temperature in CELCIUS.", new Double(0), "Celsius"), binding);
    //
    // ScriptExecutor executor = new ScriptExecutor(request);
    //
    // Parameter out = (Parameter) executor.calculate(new Parameter("test", "Parameter201",
    // "The temperature in FAHRENHEIT.", 200d,
    // "Fahrenheit"));
    // assertNotNull(out);
    // assertTrue(out instanceof Parameter);
    ...
    // ScriptExecutionRequest request = new ScriptExecutionRequest("OnOffSpline", "", "javascript", new
    // Label("ScriptEngine", "Parameter300",
    // "Whether the battery is ON or OFF", "ON"), binding);
    //
    // ScriptExecutor executor = new ScriptExecutor(request);
    //
    // Label out = (Label) executor.calculate(new Parameter("test", "Parameter301", "The ON / OFF threshold.", 300d,
    // "Volt"));
    //
    ...
    // ScriptExecutionRequest request = new ScriptExecutionRequest("GeospartialDistance", "", "javascript", new
    // Parameter("ScriptEngine", "DistanceFromAtoB",
    // "The distance from A to B", 0d, "Meter"), binding);
    //
    // ScriptExecutor executor = new ScriptExecutor(request);
    //
    // GroundStation gs1 = new GroundStation("Copenhagen", "Copenhagen", new D3Vector("", "", "", "", 49.982314d,
    // 8.811035d, 0d));
    // GroundStation gs2 = new GroundStation("Frankfurt", "Frankfurt", new D3Vector("", "", "", "", 55.61683d,
    // 12.601318d, 0d));
    //
    ...
    // ScriptExecutionRequest request = new ScriptExecutionRequest("BatteryRechargeTime", "", "javascript", new
    // Parameter("ScriptEngine", "Recharge Time",
