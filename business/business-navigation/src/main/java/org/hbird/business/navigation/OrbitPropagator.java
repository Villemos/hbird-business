...
public class OrbitPropagator {
	...
	public OrbitPredictionRequest propagate(@Body OrbitalState state) {
		synchronized(this) {
			OrbitPredictionRequest request = new OrbitPredictionRequest("Orbital State Propagator", name, "A request generated by the automated orbit propagator.", state.getSatelitte(), state, locations);
