 ...
 *
 * The orbit propagation will calculate
 * <li>The Orbital State of the satellite, i.e.the position, velocity and momentum at a specific time.</li>
 * <li>Contact events (Start-End of visibility) to specific (sets of) locations, i.e. ground stations.</li>
 *
...
public interface IOrbitPrediction {
	...
	/**
	 * Propagate the orbit of a satellite
	 * <li>From NOW using the last available TLE for the satellite.</li>
	 * <li>Delta propagation for 12 hours.</li>
	 * <li>Calculating contact events to all known locations.</li>
	 * <li>Returning the results as a Dataset.</li>
	 * 
	 ...
	 * Propagate the orbit of a satellite
	 * <li>From [from].</li>
	 * <li>Delta propagation until [to].</li>
	 * <li>Calculating contact events to all known locations.</li>
	 * <li>Returning the results as a Dataset.</li>
	 * 
	 * @param satellite The name of the satellite whose orbit shall be propagated.
	 ...
	 * <li>From [from].</li>
	 * <li>Delta propagation until [to].</li>
	 * <li>Calculating contact events to the specified location.</li>
	 * <li>Returning the results as a Dataset.</li>
	 * 
	 * @param satellite The name of the satellite whose orbit shall be propagated.
	 ...
	 * <li>From [from].</li>
	 * <li>Delta propagation until [to].</li>
	 * <li>Calculating contact events to the listed set of locations.</li>
	 * <li>Returning the results as a Dataset.</li>
	 * 
	 * @param satellite The name of the satellite whose orbit shall be propagated.
	 ...
	 * <li>Delta propagation for 12 hours.</li>
	 * <li>Calculating contact events to all known locations.</li>
	 * <li>Returning the results as a stream on the monitoring topic.</li>
	 * 
	 * @param satellite The name of the satellite whose orbit shall be propagated.
	 * @return A DataSet containing all orbital events.
	 */
