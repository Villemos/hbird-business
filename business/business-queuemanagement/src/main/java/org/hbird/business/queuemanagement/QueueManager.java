...
public class QueueManager {
     ...
     * @throws Exception
     */
    public List<String> listQueues() throws MalformedObjectNameException, MalformedURLException, NullPointerException, IOException, Exception {
     ...
     * @throws Exception
     */
    public Map<String, String> viewQueue(@Body ViewQueue command) throws InvalidSelectorException, OpenDataException, MalformedObjectNameException,
            MalformedURLException, NullPointerException, IOException, Exception {
