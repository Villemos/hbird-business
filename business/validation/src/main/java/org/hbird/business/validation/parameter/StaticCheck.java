...
public class StaticCheck extends BaseLimit {
	 ...
	 */
	public StaticCheck(String name, String description) {
	 ...
	 */
	public StaticCheck(String name, String description, double limit) {
		super(name, description);
