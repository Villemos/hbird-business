...
public class HeapMemoryUsageMonitor extends Monitor {
    ...
    public Parameter[] check() {
        return new Parameter[] {
                new Parameter(componentId, parameterNameHeapMemory, "MonitoredResource", "The heap memory usage",
                        ManagementFactory.getMemoryMXBean().getHeapMemoryUsage().getUsed(), "Byte"),
                new Parameter(componentId, parameterNameNonHeapMemory, "MonitoredResource",
                        "The non heap memory usage", ManagementFactory.getMemoryMXBean().getNonHeapMemoryUsage()
                                .getUsed(), "Byte"),
        };
    }
}
