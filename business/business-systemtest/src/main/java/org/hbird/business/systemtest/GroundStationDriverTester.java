...
public class GroundStationDriverTester extends SystemTest {
    ...
    public void process(CamelContext context) throws InterruptedException {
        ...
        /** The following D3Vectors, orbital states and contact events have been extracted using the navigation module based on the
        ...
        /** Send a tracking request to the driver. Notice that on creation of the driver we set 'failOldRequests' to false
...
//        	System.out.print(((NativeCommand) entry).getExecutionTime() - startTime + " (" + ((NativeCommand) entry).getExecutionTime() + ") " + ((NativeCommand) entry).getCommandToExecute());
//        }
