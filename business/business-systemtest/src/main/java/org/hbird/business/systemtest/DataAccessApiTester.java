...
public class DataAccessApiTester extends SystemTest {
	...
	public void process() throws InterruptedException {
		...
		injection.sendBody(new Location("", "LOC1", "", 0d, 0d, 0d, 0d));
		injection.sendBody(new Location("", "LOC2", "", 0d, 0d, 0d, 0d));
		injection.sendBody(new Location("", "LOC3", "", 0d, 0d, 0d, 0d));
		injection.sendBody(new Location("", "LOC1", "", 0d, 0d, 0d, 0d));
		...
		// NOTE: This will retrieve 3 ENTRIES. This will be: PARA1, STATE, STATE. The result mapped on parameters will thus be 1, and not 3.
