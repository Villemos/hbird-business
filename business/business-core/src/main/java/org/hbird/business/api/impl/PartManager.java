...
public class PartManager extends AbstractHbirdApi implements IPartManager {
	private Logger LOG = LoggerFactory.getLogger(PartManager.class);
	...
	public void start(IStartableEntity part) {
        ...
        try {
        	...
        	LOG.error("Error sending start command for entity part", e);
        }
	}
	...
	public void stop(String name) {
        ...
        try {
        	...
        	LOG.error("Error sending stop command for entity part", e);
        }
	}
