...
public class ApiUtility {
	...
	public static Map<Parameter, List<State>> sortParametersAndState(List<EntityInstance> elements) {
		...
		for(Iterator<EntityInstance> it = elements.iterator(); it.hasNext();) {
			EntityInstance element = it.next();
