...
public class HamlibDriverConfiguration extends GroundStationConfigurationBase {
    ...
    public HamlibDriverConfiguration(String serviceId, String serviceVersion, int heartbeatInterval, String groundstationId, String deviceName, String deviceType, int devicePort, String deviceHost, Long timerFireInterval, int pollDelayInterval, int pollRoundingScale) {
