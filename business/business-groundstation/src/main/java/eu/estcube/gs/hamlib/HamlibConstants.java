...
/**
 * Constant values for Hamlib protocol codecs.
 */
public class HamlibConstants {
    ...
    /** Hamlib protocol marker for message end. */
    public static final String DEVICE_END_MESSAGE = "RPRT";
}
