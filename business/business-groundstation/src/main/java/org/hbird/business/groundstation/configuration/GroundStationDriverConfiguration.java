...
public class GroundStationDriverConfiguration extends GroundStationConfigurationBase {
    ...
    private static final long serialVersionUID = 2824548586725989177L;
    ...
    /** Default value for skip out dated commands. */
    public static final boolean DEFAULT_SKIP_OUTDATED_COMMANDS = true;
    ...
    @Value("${skip.outdated.commands:true}")
    protected boolean skipOutDatedCommands = DEFAULT_SKIP_OUTDATED_COMMANDS;

    @Value("${pointing.data.optimizer}")
    protected String pointingDataOptimzerClassName;
    ...
    /**
     * @return the skipOutDatedCommands
     */
    public boolean isSkipOutDatedCommands() {
        return skipOutDatedCommands;
    }

    /**
     * @param skipOutDatedCommands the skipOutDatedCommands to set
     */
    public void setSkipOutDatedCommands(boolean skipOutDatedCommands) {
        this.skipOutDatedCommands = skipOutDatedCommands;
    }

    /**
     * @return the pointingDataOptimzerClassName
     */
    public String getPointingDataOptimzerClassName() {
        return pointingDataOptimzerClassName;
    }

    /**
     * @param pointingDataOptimzerClassName the pointingDataOptimzerClassName to set
     */
    public void setPointingDataOptimzerClassName(String pointingDataOptimzerClassName) {
        this.pointingDataOptimzerClassName = pointingDataOptimzerClassName;
    }
